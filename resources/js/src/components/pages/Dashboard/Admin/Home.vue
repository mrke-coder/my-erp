  ...
  <div id="home">
    <div class="row">
      <div class="col-md-3 col-sm-6 col-6 equel-grid">
        <router-link to="/dashboard/admin/rh" exact class="admin-dash-link"></router-link>
        <div class="grid">
          <div class="grid-body text-gray">
            ...
            <p class="text-black">Ressources Humaines</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6 col-6 equel-grid">
          <router-link to="#" exact class="admin-dash-link"></router-link>
        <div class="grid">
          <div class="grid-body text-gray">
            <div class="d-flex justify-content-between">
              <p>43%</p>
            ...
            <p class="text-black">Gestion Commerciale</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6 col-6 equel-grid">
        ...
        <div class="grid">
          <div class="grid-body text-gray">
            ...
            <p class="text-black">Gestion des Stocks</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6 col-6 equel-grid">
        ...
        <div class="grid">
          <div class="grid-body text-gray">
            ...
            <p class="text-black">Audits et Comptabilité</p>
          </div>
        </div>
      </div>
            ...
            <div class="wrapper">
              <div class="d-flex justify-content-between">
                <div class="split-header">
                  ...
                  <p class="card-title">Anniversaire</p>
                </div>
                <div class="wrapper">
                  <button
                    ...
                    type="button"
                  >
                    <i class="mdi mdi-calendar text-muted mdi-2x"></i>
                  </button>
                  <button
                    class="btn action-btn btn-xs component-flat pr-0"
                    type="button"
