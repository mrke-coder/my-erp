                        ...
                        <div class="wrapper">
                            <div class="d-flex justify-content-between">
                                <div class="split-header">
                                    <img class="img-ss mt-1 mb-1 mr-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPIwZebm5rD1USnvdsYGaOKH7tGK74t5gBbg&usqp=CAU" alt="instagram">
                ...
                <div class="grid">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            ...
                            <tr>
                                <td class="pr-0 pl-4">
                                    <img class="profile-img img-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPIwZebm5rD1USnvdsYGaOKH7tGK74t5gBbg&usqp=CAU" alt="profile image">
                                </td>
                                <td class="pl-md-0">
                            ...
                            <div class="timeline-vertical dashboard-timeline">
                                ...
                                <div class="activity-log">
                                    ...
                                    <div class="log-details">Report has been updated <div class="grouped-images mt-2">
                                        <img class="img-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPIwZebm5rD1USnvdsYGaOKH7tGK74t5gBbg&usqp=CAU" alt="Profile Image" data-toggle="tooltip" title="Gerald Pierce">
                                        <img class="img-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPIwZebm5rD1USnvdsYGaOKH7tGK74t5gBbg&usqp=CAU" alt="Profile Image" data-toggle="tooltip" title="Edward Wilson">
                                        <img class="img-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPIwZebm5rD1USnvdsYGaOKH7tGK74t5gBbg&usqp=CAU" alt="Profile Image" data-toggle="tooltip" title="Billy Williams">
                                        <img class="img-sm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPIwZebm5rD1USnvdsYGaOKH7tGK74t5gBbg&usqp=CAU" alt="Profile Image" data-toggle="tooltip" title="Lelia Hampton">
