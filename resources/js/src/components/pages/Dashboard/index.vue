                    ...
                    <div class="t-header-content">
                        ...
                        <ul class="nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                >
                                    <i
                                        class="mdi mdi-message-outline mdi-1x"
                                    ></i>
                                    <span
                                    ...
                                    <div class="dropdown-body">
                                        <div class="dropdown-list">
                                            <div class="image-wrapper">
                                                <img
                                                    class="profile-img"
                                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPIwZebm5rD1USnvdsYGaOKH7tGK74t5gBbg&usqp=CAU"
                                                    alt="profile image"
                                                />
                                                <div
                            ...
                            <li class="nav-item dropdown">
                                ...
                                >
                                    ...
                                    <div class="dropdown-body border-top pt-0">
                                        ...
                                        >
                                            <i
                                                class="grid-icon mdi mdi-account mdi-2x"
                                            ></i>
                                        ...
                                        >
                                            <i
                                                class="grid-icon mdi mdi-settings mdi-2x"
                                            ></i>
                                            <span class="grid-tittle"
                                                >Paramètres</span
                                            >
                                        ...
                                        >
                                            <i
                                                class="grid-icon mdi mdi-help mdi-2x"
                                            ></i>
                                            <span class="grid-tittle"
                                                >Aides</span
                                            >
                                        ...
                                        >
                                            <i
                                                class="grid-icon mdi mdi-logout mdi-2x"
                                            ></i>
                                            <span class="grid-tittle"
                                                >Déconnexion</span
                                            >
            ...
            <div class="page-body">
                ...
                <div class="page-content-wrapper">
                    ...
                    <footer class="footer">
                        <div class="row">
                            <div
                                class="col-sm-6 text-center text-sm-right order-sm-1"
                            >
                                <ul class="text-gray">
                                    <li>
                                        <router-link to="#"
                                            >Conditions
                                            d'utilisation</router-link
                                        >
                                    </li>
                                    <li>
                                        <router-link to="#"
                            ...
                            <div
                                class="col-sm-6 text-center text-sm-left mt-3 mt-sm-0"
                            >
                                <small class="text-muted d-block"
                                    >Copyright © 2020
                                    <a href="mailto:ernestkouassi02@gmail.com"
                                        >Ernest K.</a
                                    >. Tous les droits sont réservés</small
                                >
                            </div>
                        </div>
                    </footer>
...
export default {
        ...
        return {
            languages: [
                ...
                },
                {
                    name: "French",
                    languageCode: "fr",
                    path: require("../../../assets/flags/fr.png")
                }
            ],
            loading: true,
            min_progress: 5,
    ...
    created() {
        ...
        $(function() {
            $(".t-header-mobile-toggler").on("click", function() {
    ...
    methods: {
        ...
        logout: async function() {
            auth.logout();
            this.$toastr.success(
                "Vous avez mis fin à votre session, à bientôt"
            );
